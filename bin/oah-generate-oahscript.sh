#!/bin/bash
# ---------------------------------------------------------------------------
# ove-gen-script - OVE library script template generator

# Copyright 2015, Vinod Panicker <vpanicke@gmail.com>

# MIT/BSD License

# Usage: ove-gen-script [-h|--help] [-q|--quiet] [-s|--root] [script]
...
#TODO get the users name from git config
...
if [[ $quiet_mode ]]; then
  ...
  # License
  read -p "Include license header [y/n]? > "
